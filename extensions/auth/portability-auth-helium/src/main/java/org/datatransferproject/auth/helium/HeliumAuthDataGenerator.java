...
public class HeliumAuthDataGenerator implements AuthDataGenerator {
  private static final String AUTHORIZATION_SERVER_URL = "https://auth.commonsshare.org/authorize";
  private static final String TOKEN_SERVER_URL = "https://auth.commonsshare.org/token";
  private final AppCredentials appCredentials;
  private final HttpTransport httpTransport;
  private final List<String> scopes = ImmutableList.of("openid", "profile", "email");

  HeliumAuthDataGenerator(AppCredentials appCredentials, HttpTransport httpTransport) {
